...
<table border="0" class="menutable" cellpadding="0" cellspacing="0"  width="180" style="border-collapse: collapse" bordercolor="#111111">
  <tr>
    ...
    <img src="img/arrow.gif" width="10" height="10">&nbsp;</font><a href="order.asp?sid=<%=sid%>&orderno=<%=orn%>&os=<%=os1%>"><%=os2%></a>
     <font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<img src="img/arrow.gif" width="10" height="10">&nbsp;</font></th>
  </tr>
  <%   
If rs.eof then
response.write "<tr><td> No orders!</td></tr>"
...
End if
 %>
   <tr>
        <td width="180">&nbsp; 
    <img src="img/arrow.gif" width="10" height="10">&nbsp;<a href="order.asp?sid=<%=sid%>&os=<%=os%>&orderno=<%=orderno%>"><%=orderno%></a><%=accept%><% if orderst>0 and orderst <1 Then Response.write " * "%></td>
              </tr>
      <%
rs.MoveNext
if trow="#FCFBFF" Then	   	   
